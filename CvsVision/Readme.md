...
|------|:-------------:|--------|
| 2024.12.13 | [cvsCam SDK](https://github.com/CREVIS/Camera/tree/master/cvsCam/Windows) | CvsVision Library 1.0.0.3 이상 사용시 cvsCam 1.0.5 이상 필요|
...
|------|---------|:-------------:|--------|----|
| 2024.12.13 | 1.0.0.3| [Download](https://github.com/CREVIS/Camera/raw/master/CvsVision/CvsVision%20Library%201.0.0.3.zip1)| Vision Tool Library | x64 Windows 10 이상 |
...
|------------------------------------|------------------------------|---------------------------|
| 2024.12.13 |1.0.0.3| <br>***[cvs_vision]*** <br> <ul> **1. cvs_init_buffer, cvs_free_buffer 함수 내부 InitLibrary 체크 해제**  <br> </ul> ***[CvsVisionCSharp]*** <br> <ul> 1. CvsCamDotNet 카메라 라이브러리로 변경 <br> 2. ICvsImage, CvsOverlay 클래스 Clone() 추가 <br><br>|
