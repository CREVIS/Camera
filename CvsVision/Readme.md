...
|------|---------|:-------------:|--------|----|
| 2026.05.18 | 1.0.0.5| [Download](https://github.com/CREVIS/Camera/releases/download/CvsVision/CvsVision.SDK.1.0.0.5.x64.Setup.exe)| cvsCam v1.1.5 이상 호환 | x64 Windows 10 이상 |
...
| 2026.01.09 | CvsVisionGPU| [Download](https://github.com/CREVIS/Camera/releases/download/CvsVision/CvsPythonGPU.7z) | [<img src="https://github.com/CREVIS/Camera/raw/master/CvsVision/crevis.ico" width="20" align="middle"> 설치메뉴얼](https://github.com/CREVIS/Camera/blob/master/CvsVision/CvsVision%20%EC%84%A4%EC%B9%98%20%EB%A7%A4%EB%89%B4%EC%96%BC.pdf) | x64 Windows 10 이상 |
...
|------------------------------------|------------------------------|---------------------------|
| 2026.05.18 |1.0.0.5| <br>***[cvs_vision]*** <br> <ul> **1. CheckerboardCalibrationTool 추가** <br><br> **2. TemplateMatchTool 업데이트** <br> <ul> <li> 속도 개선. <br> <li> scale 기능 추가. <br> <li> 서브픽셀 검출 지원. <br> <li> Angle 검출 개선. <br> <br> </ul> **3. .cvst 파일 이미지 저장 방식 변경** <br> <br> **4. BrightnessTool, RgbMatchTool, FindBarcode 에서 .cvst형식 변경**  <br> </ul> </ul> ***[CvsVisionCSharp]*** <br> <ul> **1. 일부 클래스 및 구조체 변수명 변경**  <br> <ul> <li> LineControl: Angle에서 Rotate 변경 <br> <li> CvsAxis, structCvsAxis: Rotate에서 Angle로 변경 </ul> <br> **2. TemplateMatch, ImageMatch, Alignment 파라미터, 결과 클래스 변경** <br> <ul> <li> TemplateMatch, ImageMatch ToolEditor: 최종 결과 최대 개수, 최소 Scale, 최대 Scale, 겹침 정도, 속도 우선 모드 파라미터 추가 <br> <li> Alignment ToolEditor: 최소 Scale, 최대 Scale, 속도 우선 모드 파라미터 추가  </ul> <br> **3.CheckerboardCalibrationTool,ToolEditor 추가** <br><br> |
