...
| 2024.08.13 | [cvsCam SDK](https://github.com/CREVIS/Camera/tree/master/cvsCam/Windows) | CvsVision Library 1.0.0.2 이상 사용시 cvsCam 1.0.1 이상 필요|
...
|------------------------------------|------------------------------|---------------------------|
| 2024.12.13 |1.0.0.3| <br>***[cvs_vision]*** <br> <ul> **1. cvs_init_buffer, cvs_free_buffer 함수 내부 InitLibrary 체크 해제**  <br> <br>  </ul> ***[CvsVisionCSharp]*** <br> <ul> 1. AlignmentToolEditor 결과 표시 일부 항목 삭제 <br> 2. 에디터 바인딩 오류 패치 <br><br>|
