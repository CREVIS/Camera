...
| 2021.02.09 |4.7.3.7710| <br> <ul> <li> **1. VirtualFG40 C# 라이브러리 업데이트** <ul> <li> Event 관련 Callback 추가 </ul> <br> <li> Read / Write Param 함수 추가. </ul> <ul> <li> **2. CamGuide 버그 패치** <ul> <li> 270° Rotate 스크롤 버그 패치 </ul> </ul> <ul> <li> **3. CL 모델 추가** <ul> <li> MC-A500K-163U </ul>|
