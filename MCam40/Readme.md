...
| date | version | Update |
|------------------------------------|------------------------------|---------------------------|
| 2022.11.16 |4.8.0.8354| <br> <ul> <li> **Library** <br> <ul><li> **UpdateDevice, AcqStop, CloseDevice 함수 속도 개선.** <br><li> **XML Import 기능 추가(Export는 추후 예정)** <br><li> **U3V DeviceInfo에 현재 LinkSpeed 추가.** <br><li> **기타 버그 패치** </ul> <li> **CamGuide / CamGuide40**|
