...
| 2021.01.12 |4.7.2.7684| <br> <ul> <li> **1. U3V 드라이버 변경** <ul> <li> libusbk -> WinUSB </ul> <li>**2. CamGuide 추가 기능** <ul><li>연결 상태 확인 기능. </ul>**3. VirtualFG40 기능 추가** <ul> <li>연결 상태 확인 기능 추가 (Callback Event / Funtion) <br> <li> 이벤트 기능 추가 ( ExposureEnd, Link Status)|
