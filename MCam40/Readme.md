...
| date | version | Update |
|------------------------------------|------------------------------|---------------------------|
| 2022.11.16 |4.8.0.8354| <br> <ul> <li> **Library** <br> <ul><li> UpdateDevice, AcqStop, CloseDevice 함수 속도 개선. <br><li> XML Import 기능 추가(Export는 추후 예정) <br><li> U3V DeviceInfo에 현재 LinkSpeed 추가. <br><li> 기타 버그 패치 </ul> <li> **CamGuide / CamGuide40** <br> <ul><li> Reset Layout 기능 추가.  <br><li> XML Import / Export 기능 개선. <br><li>Tooltip 정보 개선. <br><li> AcqStop Command 시 오동작 수정. </ul> <li> **CamGuide** <br> <ul><li> 편광 Display 항목 추가. <br><li> User Set Load 시 오동작 수정. </ul> <li>**CamGuide40** <br> <ul><li> User Set Save 시 오동작 수정. </ul> <li> **C# Library / Example**<br> <ul><li> .Net3.5 에서 빌드 되지 않는 현상 수정. <br><li> Callback Example 수정. <br><li> 참조 깨지는 현상 수정.  </ul> <li>**배포판** <br> <ul><li> SDK 설치시 U3V 제외하고 설치하면 발생하는 오동작 수정. <br><li> Licence 파일 첨부.|
