...
| 2022.11.16 | 4.8.0.8354 | [Download](https://github.com/CREVIS/Camera/raw/master/MCam40/Download%20Files/MCam40_Runtime_V4.8.0.8354(x86).zip)| <ul><li>MCam40_Runtime_V4.8.0.8354(x86)<br/></li> |
...
| date | version | Update |
|------------------------------------|------------------------------|---------------------------|
| 2024.12.12 |4.8.1.9105| <br> VirtualFG40  <br> <ul> <li> GigE 카메라 ST_AcqStart(), ST_AcqStop() 반복 실행시 핸들 누수 패치. <br><br>
공통 : AMD CPU에서 U3V 영상 획득 안되는 현상 패치 |
| 2022.11.16 |4.8.0.8354| <br> [KOR] <br> <ul> <li> **Library** <br> <ul><li> UpdateDevice, AcqStop, CloseDevice 함수 속도 개선. <br><li> XML Import 기능 추가(Export는 추후 예정) <br><li> U3V DeviceInfo에 현재 LinkSpeed 추가. <br><li> 기타 버그 패치 </ul> <li> **CamGuide / CamGuide40** <br> <ul><li> Reset Layout 기능 추가.  <br><li> XML Import / Export 기능 개선. <br><li>Tooltip 정보 개선. <br><li> AcqStop Command 시 오동작 수정. </ul> <li> **CamGuide** <br> <ul><li> 편광 Display 항목 추가. <br><li> User Set Load 시 오동작 수정. </ul> <li>**CamGuide40** <br> <ul><li> User Set Save 시 오동작 수정. </ul> <li> **C# Library / Example**<br> <ul><li> .Net3.5 에서 빌드 되지 않는 문제 수정. <br><li> Callback Example 수정. <br><li> 참조 깨지는 현상 수정.  </ul> <li>**배포판** <br> <ul><li> SDK 설치시 U3V 제외하고 설치하면 발생하는 오동작 수정. <br><li> Licence 파일 첨부. <br><br> <br> </ul> </ul>[ENG] <br> <ul> <li> **Library** <br> <ul><li> Improved the running time of UpdateDevice, AcqStop, and CloseDevice functions. <br><li> Added XML Import function(Export: TBD) <br><li> Added current LinkSpeed to U3V DeviceInfo. <br><li> Patched the bugs </ul> <li> **CamGuide / CamGuide40** <br> <ul><li> Added Reset Layout function. <br><li> Improved XML Import / Export function. <br><li>Improved Tooltip information. <br><li> Corrected malfunction of AcqStop Command. </ul> <li> **CamGuide** <br> <ul><li> Added Polarization Display. <br><li> Corrected malfunction of User Set Load. </ul> <li>**CamGuide40** <br> <ul><li> Corrected malfunction when saving user set (User Set Save). </ul> <li> **C# Library / Example**<br> <ul><li> Fixed the issue that was not build in.Net3.5. <br><li> Corrected Callback Example. <br><li> Corrected the reference break.  </ul> <li>**Distribution Ver** <br> <ul><li> Corrected malfunction when installing SDK except for U3V. <br><li> Licence file attached.|
...
| 2021.03.30 |4.7.4.7758| <br> <ul> <li> **아이콘 변경.(CamGuide, CamGuide40, CamGuideCL, MvIpConfig)** <br><br> <li> **VirtualFG40 ST_CvtColor 함수 버그 패치** <br><br> <li> **CamGuide,CamGuide40** <br> <ul> <li> Auto Contrast 폴링 기능 추가 </ul> <br> <li> **CamGuide 편광 Degree 디스플레이 버그 수정** <br> <ul> <li> Degree 90° 에서 스크롤바 제어시 디스플레이 멈추는 버그 수정|
| 2021.02.10 |4.7.3.7711| <br> <ul> <li> **VirutualFG40 버그 패치**|
| 2021.02.09 |4.7.3.7710| <br> <ul> <li> **VirtualFG40 C# 라이브러리 업데이트** <ul> <li> Event 관련 Callback 추가 <br> <li> Read / Write Param 함수 추가. </ul> <br> <li> **CamGuide 버그 패치** <ul> <li> 270° Rotate 스크롤 버그 패치 </ul> <br> <li> **CL 모델 추가** <ul> <li> MC-A500K-163U </ul>|
| 2021.01.12 |4.7.2.7684| <br> <ul> <li> **GamGuide CL 통합**  </ul> <ul> <li> **U3V 드라이버 변경** <ul> <li> libusbk -> WinUSB </ul> <li>**CamGuide 추가 기능** <ul><li>연결 상태 확인 기능. </ul><li>**VirtualFG40 기능 추가** <ul> <li>연결 상태 확인 기능 추가 (Callback Event / Funtion) <br> <li> 이벤트 기능 추가 ( ExposureEnd, Link Status) </ul><li>**FilterDriver 이름 변경** <ul> <li>s2i -> Crevis </ul> <li>**버그 패치** <br><li>**라이브러리 / 실행파일 / 설치 파일 Codesign 진행** |
...
| 2018.09.04 |4.4.0| <ul><br><li>**모델 추가**  <ul><li>GigE : 현재 버전부터는 “Device Vendor Name (Crevis Co., LTD)”으로 리스트 업 되기 때문에 향후 신규 추가 요청은 필요 없음. </ul><ul><li>USB2.0 : MV-BW35U, MV-CW35U 모델 추가. **</ul><li>메뉴얼 오탈자 수정** **<li>예제 오탈자 수정** **<li>C# 라이브러리(VirtualFG40Library) 업데이트** <li> **Library 버그 패치** </li> |
