...
| 2021.01.12 |4.7.2.7684| <br> <ul> <li> **1. GamGuide CL 통합** <ul> <li> **2. U3V 드라이버 변경** <ul> <li> libusbk -> WinUSB </ul> <li>**3. CamGuide 추가 기능** <ul><li>연결 상태 확인 기능. </ul><li>**4. VirtualFG40 기능 추가** <ul> <li>연결 상태 확인 기능 추가 (Callback Event / Funtion) <br> <li> 이벤트 기능 추가 ( ExposureEnd, Link Status) </ul><li>**5. FilterDriver 이름 변경** <ul> <li>s2i -> Crevis </ul> <li>**6. 버그 패치** <br><li>**7. 라이브러리 / 실행파일 / 설치 파일 Codesign 진행** |
