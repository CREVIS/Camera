...
|---|---|---|-------------|
| 2025.07.14 | 2.4.3.0 | [Download(x86)](https://github.com/CREVIS/Camera/releases/download/CamGuideCL/CamGuideCL.32bit.2.4.3.exe) <br> [Download(x64)](https://github.com/CREVIS/Camera/releases/download/CamGuideCL/CamGuideCL.64bit.2.4.3.exe)  | <ul><li>SWIR 카메라 신규 명령어 추가 <br/></li> <ul><li>TEC, Sharpness, Contrast</li>|
| 2025.07.14 | 2.3.6 < X.X.X < 2.4.3 | ... | <ul><li>2.3.6 ~ 2.4.3 사이 버전은 MCam40 4.6 ~ 4.8.0.8354 으로 통합 |
